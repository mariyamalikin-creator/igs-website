      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-4 sm:mb-14">
          ...
          <p className="font-body text-onyx/70 text-lg leading-relaxed max-w-xl mx-auto">
            Infinity Global Solutions is built on deep knowledge of Thailand&apos;s
            legal and property landscape, and a commitment to guiding international
            clients safely through every process.
          </p>
